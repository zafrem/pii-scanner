...
This guide explains how to run the PII Scanner using Docker containers.
...
# Inspect volume
docker volume inspect pii-scanner_ollama_data

# Backup volumes
docker run --rm -v pii-scanner_ollama_data:/data -v $(pwd):/backup alpine tar czf /backup/ollama_backup.tar.gz -C /data .

# Restore volumes
docker run --rm -v pii-scanner_ollama_data:/data -v $(pwd):/backup alpine tar xzf /backup/ollama_backup.tar.gz -C /data
```
