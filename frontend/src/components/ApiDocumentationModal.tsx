            ...
            <div
              dangerouslySetInnerHTML={{
                __html: `
                  ...
                  <div class="api-docs">
                    <div class="header">
                      <h1>🔍 PII Scanner API Documentation</h1>
                      <p>Comprehensive API reference for the PII Scanner backend services</p>
                    </div>
                    ...
                    <section class="section" id="overview">
                      <h2>🎯 Overview</h2>
                      <p>The PII Scanner consists of three main API services working together to provide comprehensive personally identifiable information (PII) detection:</p>
